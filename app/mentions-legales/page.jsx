...
export const metadata = {
  ...
  description: "Ce sont les mentions légales",
};
    ...
    <div className="mentions">
      <div className="mentions-text">
        ...
        <p>
          ...
          social est situé au 525 Brannan St Suite 300, San Francisco, CA 94107,
          États-Unis, joignable par le moyen suivant :{" "}
          <a href="support@render.com">support@render.com</a>
        </p>

        <h3>
          Conseils sur les achats de casque, lunettes, vêtements et chaussures
          de vélo :
        </h3>

        <p>
          Le site equipement-velo.fr propose des conseils sur les achats de
          casques, lunettes, vêtements et chaussures de vélo. Les informations
          fournies sont à titre informatif uniquement et ne constituent pas des
          recommandations professionnelles. Les utilisateurs du site
          equipement-velo.fr sont invités à consulter un expert en la matière
        ...
        <p>
          ...
          responsable des décisions prises par les utilisateurs sur la base des
          informations fournies sur le site. Les conseils sont donnés à titre
          indicatif, et l&apos;éditeur ne garantit pas l&apos;exactitude ou la
          pertinence de ces conseils pour chaque utilisateur.
        </p>

        <h3>Droits d&apos;auteur :</h3>

        <p>
          Le contenu du site equipement-velo.fr, y compris les conseils et les
          informations fournies, est protégé par le droit d&apos;auteur. Toute
        ...
        <p>
          ...
          appareil mobile par votre navigateur web. Ce site utilise des cookies
          de Google Analytics, ils sont utilisés à des fins d&apos;analyse et
          d&apos;amélioration de l&apos;expérience utilisateur. Ils permettent
          de collecter des données statistiques sur la manière dont les
        ...
        <p>
          ...
          n&apos;est pas responsable du contenu des sites visités via ces liens
          hypertextes. Les liens sont fournis à des fins d&apos;information et
          de commodité, et l&apos;utilisation de ces liens est à la discrétion
          des utilisateurs. En cliquant sur ces liens, vous reconnaissez le fait
          que vous quittez notre site et que nous n&apos;avons aucun contrôle
          sur le contenu des sites externes.
        </p>

        <h3>Programmes d&apos;affiliation :</h3>

        <p>
          Le site equipement-velo.fr participe aux programmes d&apos;affiliation
          d&apos;Amazon et Alltricks. En tant que participant à ces programmes,
          nous pouvons recevoir des commissions sur les ventes générées par des
          liens d&apos;affiliation. Ces commissions contribuent au financement
          du site mais il est important de noter que la participation à ces
          programmes n&apos;affecte en rien les coûts des produits ou services
        ...
        <p>
          ...
          découlant de l&apos;utilisation de ce site sera régi par les lois de
          la France.
        </p>
      </div>
    </div>
